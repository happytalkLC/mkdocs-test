...
| status             | String   | [상담방 상태](#happytalk-customer-counselinglist_customerid-response-chat-status)             |
...
<a id=happytalk-customer-counselinglist_customerid-response-chat-phone_os></a>- phone_os
